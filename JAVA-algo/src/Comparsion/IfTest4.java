...
public class IfTest4 {
	...
	public static void main(String[] args) {
		...
		else if(ave>ave1 && ave1>ave2) {
			System.out.println("1등 :"  +ave );
		}
			else if (ave1>ave2) {
				System.out.println("1등 :" +ave);
				System.out.println("2등 :" +ave1);
				System.out.println("3등 :" +ave2);
			} else {
				System.out.println("2등 :" +ave2);
				System.out.println("3등 :" +ave1);
		}
